...
export default class Level_05
{
    ...
    stopSong() 
    {
        // Stop the song and reset its current time to the beginning
        this.audio.pause();
        this.audio.currentTime = 0;  // reset song to the start
        this.playing = false;  // set the playing flag to false
    ...
    resetSession() 
    {
        ...
        // Clear the recordedMoments_Array to reset the session
        this.recordedMoments_Array = [];
    
        // Reset any other game state you might need to
        // For example, resetting game scores, player position, etc.
